...
<head>
    ...
    <title>Cor do Produto</title>
    <link rel="shortcut icon" href="imgs/icone_terno.png" type="image/x-icon">
    <link rel="stylesheet" href="Css/estilo_cor.css">
...
<body>
    <header>
        <div class="div_header_h1_img">
            ...
            <h1>Cadastrar Cor do Produto</h1>
        </div>
        <nav>
        ...
        <form action="./mysqlphp/mydb.php" method="GET">
            <section class="section_inputs_listar">
                <section class="section_inputs">
                    ...
                    <div class="div_inputs_labekl">
                        <label>ID Cor:</label>
                        <input placeholder="0" class="not_disabled" name="ID Cor" onclick="crrr('id')" id="id" type="number">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>Nome da Cor:</label>
                        <input placeholder="Camuflado" class="not_disabled" name="Nome da Cor" onclick="crrr('name')" id="name" type="text">
                    </div>
                ...
                <section class="section_listar">
                    <div class="div_botoes_tabela">
                        <input class="botão_not_header bt_alterar" type="submit" value="Salvar" name="alterar_cor">
                        <input class="botão_not_header bt_alterar_form" type="submit" onclick="func_alter()" form="" value="Alterar" name="alterar_cor">
                        <input class="botão_not_header bt_excluir" type="submit" value="Excluir" name="deletar_cor">
                    ...
                    <div class="tabela">
                        ...
                        <table>
                            ...
                            foreach($registro as $valor){
                                ?>
                                    <tr class="tr">
                                        <td class="td_id <?php echo $valor['id_cor']?>" onclick="click_t(<?php echo $valor['id_cor']?>)"><?php echo $valor['id_cor']?></td>
                                        <td class="td_none <?php echo $valor['id_cor']?>" onclick="click_t(<?php echo $valor['id_cor']?>)"><?php echo $valor['nome']?></td>
                                    </tr>
                                <?php
                            }
                            ?>
            ...
            <section class="botoes">
                <input onclick="valideichon()" class="botão_not_header" id="salvar" type="submit" name="form_cor" value="Salvar">
                <button onclick="valideichon()" form="" class="botão_not_header" id="cadastrar">Cadastrar</button>
                <button  class="botão_not_header" form="./mysqlphp/mydb.php" onclick="listar()" id="listar">Listar</button>
            </section>
        </form>
