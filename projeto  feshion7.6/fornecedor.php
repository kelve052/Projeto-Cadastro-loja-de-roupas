...
<body>
    ...
    <main>
        <form action="./mysqlphp/mydb.php" method="GET">
            <section class="section_inputs_listar">
                <section class="section_inputs">
                    ...
                    <div class="div_inputs_labekl">
                        ...
                        <input placeholder="0" class="not_disabled" name="ID Fornecedor" onclick="crrr('id')" id="id" type="number">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>CNPJ:</label>
                        <input placeholder="02.154.458/0001-45" class="not_disabled" name="CNPJ" onclick="crrr('cnpj')" id="cnpj" type="number">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>Nome:</label>
                        <input placeholder="Sacul" class="not_disabled" name="Nome" onclick="crrr('name')" id="name" type="text">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>Endereço:</label>
                        <input placeholder="Rua-Jardim Nº1254" class="not_disabled" name="Endereço" onclick="crrr('address')" id="address" type="text">
                    </div>
                ...
                <section class="section_listar">
                    <div class="div_botoes_tabela">
                        <input class="botão_not_header bt_alterar" type="submit" value="Salvar" name="alterar_fornecedor">
                        <input class="botão_not_header bt_alterar_form" type="submit" onclick="func_alter()" form="" value="Alterar" name="alterar_cor">
                        <input class="botão_not_header bt_excluir" type="submit" value="Excluir" name="deletar_fornecedor">
                    ...
                    <div id="borda_formulario1"></div>
                        <table>
                            <tr>
                                ...
                                <td class="td_header_nome">CNPJ</td>
                            </tr>
                            <?php
                            $listar = $conn->query('SELECT id_fornecedor, nome, CNPJ FROM fornecedor;');
                            $registro = $listar->fetchAll(PDO::FETCH_ASSOC);
                            foreach($registro as $valor){
                                ?>
                                    <tr class="tr">
                                        <td class="td_id <?php echo $valor['id_fornecedor']?>" onclick="click_t(<?php echo $valor['id_fornecedor']?>)"><?php echo $valor['id_fornecedor']?></td>
                                        <td class="td_none <?php echo $valor['id_fornecedor']?>" onclick="click_t(<?php echo $valor['id_fornecedor']?>)"><?php echo $valor['nome']?></td>
                                        <td class="td_valor <?php echo $valor['id_fornecedor']?>" onclick="click_t(<?php echo $valor['id_fornecedor']?>)"><?php echo $valor['CNPJ']?></td>
                                    </tr>
                                <?php
                            }
                            ?>
            ...
            <section class="botoes">
                <input onclick="valideichon()" class="botão_not_header" id="salvar" type="submit" name="form_fornecedor" value="Salvar">
    ...
    <script>
        ...
        function valideichon() {
            ...
            t(cnpj)
            t(id)
            if(id.value != "" && name.value != "" && cnpj.value != "" && address.value != "" ){
