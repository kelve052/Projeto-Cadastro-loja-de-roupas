...
<body>
    ...
    <main>
        <form action="./mysqlphp/mydb.php" method="GET">
            <section class="section_inputs_listar">
                <section class="section_inputs">
                    ...
                    <div class="div_inputs_labekl">
                        ...
                        <input placeholder="0" class="not_disabled invisivel" name="ID Cliente" onclick="crrr('id')" id="id" type="number">
                        <input disabled placeholder="0" class="not_disabled" name="ID Cliente" onclick="crrr('id')" id="id" type="number">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>Nome do Cliente:</label>
                        <input placeholder="Sacul" class="not_disabled" name="Nome do Cliente" onclick="crrr('name')" id="name" type="text">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>CPF:</label>
                        <input placeholder="5986325458-42" class="not_disabled" name="CPF" onclick="crrr('cpf')" id="cpf" type="number">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>Sexo:</label>
                        <select class="not_disabled" onclick="crrr('select_sexo')" name="Sexo" id="select_sexo">
                    ...
                    <div class="div_inputs_labekl">
                        <label>Edereço:</label>
                        <input placeholder="Rua-Jardim Nº2154" class="not_disabled" name="Endereço" onclick="crrr('address')" id="address" type="text">
                    </div>
                    <div class="div_inputs_labekl">
                        <label>Data de Nascimento:</label>
                        <input class="not_disabled" name="Data de Nascimento" onclick="crrr('data')" id="data" type="date">
                    </div>
                ...
                <section class="section_listar">
                    <div class="div_botoes_tabela">
                        <input class="botão_not_header bt_alterar" type="submit" value="Salvar" name="alterar_cliente">
                        <input class="botão_not_header bt_alterar_form" type="submit" onclick="func_alter()" form="" value="Alterar" name="alterar_cor">
                        <input class="botão_not_header bt_excluir" type="submit" value="Excluir" name="deletar_cliente">
                    ...
                    <div id="borda_formulario1"></div>
                        <table>
                            ...
                            <?php
                            $listar = $conn->query('SELECT * FROM cliente;');
                            $registro = $listar->fetchAll(PDO::FETCH_ASSOC);
                            foreach($registro as $valor){
                                ?>
                                    <tr class="tr">
                                        <td class="td_id <?php echo $valor['id_cliente']?>" onclick="click_t(<?php echo $valor['id_cliente']?>)"><?php echo $valor['id_cliente']?></td>
                                        <td class="td_none <?php echo $valor['id_cliente']?>" onclick="click_t(<?php echo $valor['id_cliente']?>)"><?php echo $valor['nome']?></td>
                                    </tr>
                                <?php
                            }
                            ?>
            ...
            <section class="botoes">
                <input onclick="valideichon()" class="botão_not_header" id="salvar" type="submit" name="form_cliente" value="Salvar">
    ...
    <script>
        ...
        const sexo = document.getElementById('select_sexo')
        ...
        function valideichon() {
            ...
            t(name)
            t(id)
            if(data.value != "" && address.value != "" && sexo.value != "" && cpf.value != "" && name.value != "" && id.value != ""){
        ...
        function restet_css () {
            ...
            address.style.border = 'var(--rosa-vermelho) solid 1px'
